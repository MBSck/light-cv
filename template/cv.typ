...
#header(
  ...
  socials: (
    ...
    (
      icon: icons.mail,
      text: [me\@mbscheuck.com],
      link: "mailto://me@mbscheuck.com",
    ),
  ),
)
...
#entry(
  styles: styles,
  title: "Doctor of Science (PhD), Astrophysics",
  company-or-university: "Max-Plack-Institute for Astronomy and University of Heidelberg",
  date: "09/2021 - present",
  location: "Heidelberg, DE",
  description: (
    [Thesis: The asymmetric structure in the inner regions of protoplanetary discs],
  ),
)
#entry(
  styles: styles,
...
#entry(
  styles: styles,
  title: "Abitur (High School Dipolma)",
...
#list(
  ...
  [The asymmetric structure of the inner disc around HD 142527 A
    with VLTI/MATISSE. *M. B. Scheuck*, et al., (submitted to _A&A_).],
  [Evidence for an eccentric traffic jam in the inner disk of the Herbig Ae star HD
    ...
    *M. Scheuck*, et al. (submitted to _A&A_).],
  [#link("https://ui.adsabs.harvard.edu/abs/2024A%26A...690A.185W/abstract")[Dynamical
  ...
  [#link("https://ui.adsabs.harvard.edu/abs/2024SPIE13095E..2WM/abstract")[oimodeler:
  ...
  [#link("https://ui.adsabs.harvard.edu/abs/2024A%26A...681A..47V/abstract")[Mid-infrared
  ...
  [#link("https://ui.adsabs.harvard.edu/abs/2021TDM.....8c5030P/abstract")[Moiré phonons
...
#skill(
  ...
  skills: ("Python (scipy, numpy, matplotlib, etc.)", "Julia", LaTeX, "Typst", "Bash", "Zsh", "Fish"),
)
#skill(
  styles: styles,
  category: "Languages",
